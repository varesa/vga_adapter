...
/* Module Version: 5.6 */
/* D:\Lattice\diamond\3.3_x64\ispfpga\bin\nt64\scuba.exe -w -n capture_pll -lang verilog -synth synplify -arch xo2c00 -type pll -fin 130.55 -mdiv 16 -ndiv 3 -trimp 0 -phasep 0 -trimp_r -adiv 21 -phases2 0 -cdiv 105 -phase_cntl STATIC -rsts2 -fb_mode 1 -fracn 4200  */
/* Fri Dec 12 23:47:21 2014 */


`timescale 1 ns / 1 ps
module capture_pll (CLKI, RESETC, CLKOP, CLKOS2)/* synthesis syn_noprune=1 *//* synthesis NGD_DRC_MASK=1 */;// exemplar attribute capture_pll dont_touch true 
    input wire CLKI;
    input wire RESETC;
    output wire CLKOP;
    output wire CLKOS2;
    ...
    defparam PLLInst_0.DCRST_ENA = "ENABLED" ;
    ...
    defparam PLLInst_0.CLKOS2_CPHASE = 104 ;
    ...
    defparam PLLInst_0.FRACN_DIV = 4200 ;
    ...
    defparam PLLInst_0.CLKOS2_DIV = 105 ;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .RST(scuba_vlo), .RESETM(scuba_vlo), .RESETC(RESETC), .RESETD(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS2="5.000207" */
             /* synthesis FREQUENCY_PIN_CLKOP="25.001034" */
             /* synthesis FREQUENCY_PIN_CLKI="130.550000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS2 5.000207
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 25.001034
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKI 130.550000
