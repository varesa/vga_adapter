...
/* Module Version: 5.6 */
/* D:\Lattice\diamond\3.3_x64\ispfpga\bin\nt64\scuba.exe -w -n pll -lang verilog -synth synplify -arch xo2c00 -type pll -fin 133 -fclkop 25.175 -fclkop_tol 1.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Tue Dec 09 17:39:41 2014 */


`timescale 1 ns / 1 ps
module pll (CLKI, CLKOP)/* synthesis syn_noprune=1 *//* synthesis NGD_DRC_MASK=1 */;// exemplar attribute pll dont_touch true 
    input wire CLKI;
    output wire CLKOP;
